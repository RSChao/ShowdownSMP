...
public class Diamond23 extends MultiParentsAdvancement  {
  ...
  public Diamond23(float x, float y,  BaseAdvancement... parents) {
    ...
    this.registerEvent(PlayerInteractEvent.class, (e) -> {
      ...
      boolean lives = player.getPersistentDataContainer().has(HeartsKey, PersistentDataType.BOOLEAN) || !Plugin.getPlugin(Plugin.class).getConfig().getBoolean("lives.enabled");
      if(hearts && lives){
